...
int main(void) {
    ...
    while (1) {
        ...
        /* UART_ReceiveString() it is a function that returns an array of characters (string) it works as it keeps adding 
         the character in the udr register that comes from the virtual terminal and checks if the character is '.'
         if the character is '.' it returns the string */
