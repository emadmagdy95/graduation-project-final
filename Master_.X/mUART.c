...
char* UART_ReceiveString(void) {
    static char string[20]; // creating an array of characters
    static char* temp; // creating pointer to character
    temp = string;
    // while loop keeps adding the characters from udr register to the string until the character equal to '.' then the while loop breaks which means the string finished 
